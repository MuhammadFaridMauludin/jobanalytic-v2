      ...
      <div class="container container-normal py-4">
        ...
        <div class="row align-items-center g-4">
                    ...
                    <div class="mb-2">
                      ...
                      <div class="input-group input-group-flat">
                        ...
                        <span class="input-group-text">
                          <a href="#" class="link-secondary" onclick="togglePassword(event)" title="Show password" data-bs-toggle="tooltip"><!-- Download SVG icon from http://tabler-icons.io/i/eye -->
          ...
          <div class="col-lg d-none d-lg-block">
            <img src="{{ asset('tabler/static/illustrations/Auth3.svg') }}" height="600" class="d-block mx-auto" alt="">
          </div>
        </div>
      </div>
    </div>
