...
class DataController extends Controller
{
    public function dataLowongan(Request $request)
    {
        ...
        return view('data.dataLowongan', compact('data', 'locations'));
    }
    ...
    public function topCompany()
    {
        ...
        return view('data.topCompany', compact('topCompanies', 'companyLabels', 'companyTotals'));
    }
    ...
    public function detailCompany(string $company)
    {
        ...
        return view('data.detailCompany', compact('jobs', 'company'));
    }
    ...
    public function topSkill()
    {
        ...
        return view('data.topSkill', compact('topSkill', 'topSkills', 'skillLabels', 'skillTotals'));
    }
    ...
    public function detailSkill(string $skill)
    {
        ...
        return view('data.detailSkill', compact('jobs', 'skill'));
    }
    ...
    public function lokasi()
    {
        ...
        return view('data.lokasi', compact('locations', 'locationLabels', 'locationTotals'));
    }
    ...
    public function detailLokasi(string $location)
    {
        ...
        return view('data.detailLokasi', compact('jobs', 'location'));
    }

    public function salary()
    {
        $salaryRoles = DB::table('jobs_clean')
            ->select('title', DB::raw('AVG((salary_min + salary_max)/2) as avg_salary'))
        ...
        return view('data.salary', compact('salaryRoles', 'salaryLabels', 'salaryTotals', 'highestSalaryRole', 'highestSalaryValue'));
    }
}